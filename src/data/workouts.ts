...
export const presetWorkouts: Workout[] = [
  {
    ...
    target: "Full Body",
    exercises: [
      { name: "Barbell Squat", sets: 4, reps: 10, durationSeconds: null, weightKg: 60, restSeconds: 60 },
  ...
  },
  {
    ...
    exercises: [
      { name: "Bench Press", sets: 5, reps: 5, durationSeconds: null, weightKg: 80, restSeconds: 90 },
      { name: "Weighted Pull-Ups", sets: 4, reps: 6, durationSeconds: null, weightKg: 15, restSeconds: 90 },
      { name: "Dumbbell Shoulder Press", sets: 4, reps: 8, durationSeconds: null, weightKg: 22, restSeconds: 60 },
      { name: "Barbell Curl", sets: 3, reps: 10, durationSeconds: null, weightKg: 30, restSeconds: 45 },
  ...
  },
  {
    ...
    exercises: [
      { name: "Back Squat", sets: 5, reps: 5, durationSeconds: null, weightKg: 100, restSeconds: 120 },
      { name: "Romanian Deadlift", sets: 4, reps: 8, durationSeconds: null, weightKg: 90, restSeconds: 90 },
      { name: "Leg Press", sets: 4, reps: 12, durationSeconds: null, weightKg: 160, restSeconds: 60 },
